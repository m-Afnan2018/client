...
import c1 from '../assets/Initiatives/C1.png';
import c2 from '../assets/Initiatives/C2.png';
import c3 from '../assets/Initiatives/C3.png';
import c4 from '../assets/Initiatives/C4.png';
...
const Initiatives = () => {
  ...
  const InCards = [
    {
      key: uuidv4(),
      content: <img src={c1} alt='1' />
    },
    {
      key: uuidv4(),
      content: <img src={c2} alt='2' />
    },
    {
      key: uuidv4(),
      content: <img src={c3} alt='3' />
    },
    {
      key: uuidv4(),
      content: <img src={c4} alt='4' />
    }
  ].map((slide, index) => {
    return {
      ...slide,
